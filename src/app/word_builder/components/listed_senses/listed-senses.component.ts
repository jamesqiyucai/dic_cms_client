...
import {WordBuilderListedSensesComponentModel} from './model/word-builder-listed-senses-component-model.interface';
import {
  NewListedSensesComponentModelComposer
} from '../shared/factories/new-component-model-composer.interface';
...
} from '../shared/factories/implementations/word-builder-new-component-model-composer.class';
import {List} from 'immutable';
import {WordBuilderNewSenseFactoryImpl} from '../shared/factories/implementations/word-builder-new-sense-factory.class';
import {WordBuilderNewSensePositionFactoryImpl} from '../shared/factories/implementations/word-builder-new-sense-position-factory.class';
import {NewComponentExampleFactoryImpl} from '../shared/factories/implementations/word-builder-new-example-factory.class';
